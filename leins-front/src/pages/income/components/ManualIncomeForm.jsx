...
const ManualIncomeForm = ({ entityId, onSuccess, onCancel }) => {
   ...
   const {
      register,
      handleSubmit,
      setValue, // lo usaremos para formatear el rut al escribir
      formState: { errors },
   } = useForm({
   ...
   const onSubmit = async (data) => {
      ...
      try {
         ...
         toast.success('ingreso manual registrado con exito');
         if (onSuccess) onSuccess();

      } catch (err) {
         setGlobalError(err.message || 'ocurrio un error al registrar el ingreso');
         scrollToError();
      } finally {
   ...
   return (
      <div className="relative p-1">
         ...
         {/* form contenedor flex para manejar el scroll interno */}
            ...
            <div className="shrink-0 flex items-center gap-4 pb-3 mb-4 border-b border-border-subtle">
               ...
               <div>
                  ...
                  <p className="text-sm text-text-soft mt-0.5">
                     Complete la información para registrar un ingreso externo al flujo del SII.
                  </p>
               </div>
            </div>

            {/* area con scroll para los campos */}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div className="space-y-1.5 relative md:col-span-2">
                        ...
                        <div className="relative">
                           ...
                           >
                              <option value="">
                                 {loadingEntities ? 'Cargando entidades...' : 'Seleccione la entidad asignada'}
                              </option>
                              {entities.map((e) => (
                           ...
                           <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-text-soft pointer-events-none">
                              <IconChevronDown />
                           </span>
                        </div>
                     ...
                     <div>
                        <FormInput
                           ...
                           {...register('counterparty_rut', {
                              onChange: (e) => {
                                 // interceptamos para formatear en tiempo real
