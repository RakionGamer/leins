                                 ...
                                 <td className="p-4 text-center">
                                    <div className="flex flex-col items-center gap-1">
                                       ...
                                       {r.credit_notes_applied > 0 && !isNC && (() => {
                                          ...
                                          return (
                                             <div 
                                                className={`mt-1.5 flex items-center justify-center gap-1.5 px-2.5 py-1 border bg-gradient-to-r ${isAnnulled ? 'from-rose-50 to-red-50 border-rose-200/60 hover:border-rose-300' : 'from-blue-50 to-indigo-50 border-blue-200/60 hover:border-blue-300'} shadow-sm rounded-lg hover:shadow-md transition-all cursor-help`}
