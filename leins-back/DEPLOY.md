...
- `leins-back` (este repo) — API Node/Express, corre con PM2 en el servidor.
- `leins-front` (repo hermano) — SPA React + Vite, se compila y se sube como archivos estáticos.
